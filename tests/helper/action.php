...
if(php_sapi_name() == 'cli-server')
{
    ...
    {
        helper\Action::execute($_SERVER['PATH_INFO']);
    }
    else
    {
        die("NOT FOUND");
...
else
{
    ...
    class TestAction extends WebTestCase
    {
        ...
        {
            $this->get(TEST_URL . '/helper/action.php/top');
            $this->assertTitle('Top Action');

            $this->get(TEST_URL . '/helper/action.php/top2');
            $this->assertTitle('Top2 Action');
            
            $this->get(TEST_URL . '/helper/action.php/top2/data');
            $this->assertTitle('Top2 Action data');
            
            $this->get(TEST_URL . '/helper/action.php/top2/quasi');
            $this->assertTitle('Top2 Action quasi');
            
            $this->get(TEST_URL . '/helper/action.php/top2/lambda/wow');
